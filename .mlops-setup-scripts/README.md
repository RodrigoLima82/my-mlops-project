...
* Configure a Databricks CLI profile for your staging workspace by running
  ``databricks configure --token --profile "my-mlops-project-staging" --host https://adb-984752964297111.11.azuredatabricks.net``, 
...
* Configure a Databricks CLI for your prod workspace by running ``databricks configure --token --profile "my-mlops-project-prod" --host https://adb-984752964297111.11.azuredatabricks.net``
